...
import com.example.AlphaHealthAssistant.ui.calorieburn.dbHelper.ShoulderBeginner;
import com.google.firebase.database.DatabaseReference;
import com.google.firebase.database.FirebaseDatabase;

public class shoulder_beginner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shoulder_beginner);
        ...
        shoulderBeginner = new ShoulderBeginner();
            ...
            public void onClick(View view) {
                ...
                try {
                    if (TextUtils.isEmpty(editText01.getText().toString())) {
                        ...
                        shoulderBeginner.setExercise01(Integer.parseInt(editText01.getText().toString().trim()));
                        shoulderBeginner.setExercise02(Integer.parseInt(editText02.getText().toString().trim()));
                        shoulderBeginner.setExercise03(Integer.parseInt(editText03.getText().toString().trim()));
                        shoulderBeginner.setExercise04(Integer.parseInt(editText04.getText().toString().trim()));
                        shoulderBeginner.setExercise05(Integer.parseInt(editText05.getText().toString().trim()));
                        shoulderBeginner.setExercise06(Integer.parseInt(editText06.getText().toString().trim()));

                        //dbRef.push().setValue(abs);
                        dbRef.child("shoulder").setValue(shoulderBeginner);
                        //dbRef.setValue(abs);
